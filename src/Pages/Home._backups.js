          ...
          <div className="title-inner self-center flex w-full max-w-[1178px] items-start justify-between gap-5 -mt-px max-md:max-w-full max-md:flex-wrap max-md:justify-center">
            ...
            <div className="self-stretch flex items-start justify-between gap-1.5 max-md:justify-center">
              ...
              />
                ...
                <div className='stand-text'>English</div>
...
<div style={{ display: 'flex', justifyContent: 'center', position: 'fixed', bottom: '20px', left: '50%', transform: 'translateX(-50%)' }}>
<div className="flex flex-col" style={{ marginRight: '15px' }}>
  <FontAwesomeIcon icon={faHistory} className="circle-icon zoom-icon" />
  <div className="text-black text-opacity-50 text-center text-sm font-medium leading-[138.462%]">
    History
  </div>
</div>
<div className="flex flex-col" style={{ marginRight: '15px' }}>
  <FontAwesomeIcon icon={faSave} className="circle-icon zoom-icon" />
  <div className="text-black text-opacity-50 text-center text-sm font-medium leading-[138.462%]">
    Saved
  </div>
</div>
<div className="flex flex-col" style={{ marginRight: '15px' }}>
  <FontAwesomeIcon icon={faYoutube} className="circle-icon zoom-icon" />
  <div className="text-black text-opacity-50 text-center text-sm font-medium leading-[138.462%]">
    YouTube
  </div>
</div>
<div className="flex flex-col" style={{ marginRight: '15px' }}>
  <FontAwesomeIcon icon={faFacebook} className="circle-icon zoom-icon" />
  <div className="text-black text-opacity-50 text-center text-sm font-medium leading-[138.462%]">
    Facebook
  </div>
</div>
<div className="flex flex-col">
  <FontAwesomeIcon icon={faTwitter} className="circle-icon zoom-icon" />
  <div className="text-black text-opacity-50 text-center text-sm font-medium leading-[138.462%]">
    Twitter
  </div>
</div>
